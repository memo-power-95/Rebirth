...
namespace Alpha.Classes
{
    ...
    class OPTControllerAPI
    {
        ...
        public const int OPT_ERR_READ_OUTPUTBOARD_VISION_FAILED = 3001061;      //Failed to read the vision of NPOutput board
        ...
        public const int OPT_ERR_SET_HB_LIMIT_STATE_FAILED = 3001082;     //Failed to set high light trigger NPOutput duty limit switch state
        public const int OPT_ERR_READ_HB_LIMIT_STATE_FAILED = 3001083;    //Failed to read high light trigger NPOutput duty limit switch state
        public const int OPT_ERR_SET_HB_TRIGGER_OUTPUT_DUTY_RATIO_FAILED = 3001084;    //Failed to set high light trigger NPOutput duty limit ratio
        public const int OPT_ERR_READ_HB_TRIGGER_OUTPUT_DUTY_RATIO_FAILED = 3001085;    //Failed to read high light trigger NPOutput duty limit ratio
