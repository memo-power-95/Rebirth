...
{
    public partial class LotForm : ModuleBaseForm
    {
        ...
        private void FakeLoad()
        {
            ...
            MESLib.CommParas.Frm_ModuleList.Dock = DockStyle.Fill;
            Panel_Module.Controls.Add(MESLib.CommParas.Frm_ModuleList);
        }
    }
}
