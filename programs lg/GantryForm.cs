...
namespace Alpha._0.ModuleForms
{
    public partial class GantryForm : ModuleBaseForm
    {
        ...
        #region Initial
        //MOD@@ Reinicio rapido - portado de Bottom station <RRP_0001>
        public void RestartProcessQuick()
        {
            if (SysPara.SystemRun)
            {
                MessageBox.Show("Detenga la maquina antes de usar el reinicio rapido.");
                return;
            }
            ...
            reintento.fnSetTextMessageNShow(
                "REINICIO RAPIDO. Se limpiara el estado del proceso. Confirme que no hay PCB en los grippers.",
                true, false, true);
            ...
            try
            {
                ...
                SysPara.ProductCount = 12;
                SysPara.FeederProductCount = 42;
                SysPara.R1AssembResult = false;
                ...
                MesTestList = new List<bool>() { true, true, true, true, true, true,
                ...
                MiddleLayer.LogF.AddLog(LogType.Production,
                    "Reinicio rapido ejecutado. Estado de proceso limpiado.", true);
                MessageBox.Show("Reinicio rapido completado. Puede iniciar produccion.");
            }
            catch (Exception ex)
            {
                MiddleLayer.LogF.AddLog(LogType.Production,
                    "Error en reinicio rapido: " + ex.Message, true);
                MessageBox.Show("Error en reinicio rapido: " + ex.Message);
            }
        }
