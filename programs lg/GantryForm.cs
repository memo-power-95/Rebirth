...
namespace Alpha._0.ModuleForms
{
    public partial class GantryForm : ModuleBaseForm
    {
        ...
        //  no era invocada por ningun nodo. Equivale al RestartProcess de la
        //  maquina Bottom Station (RRP_0001, Aaron Estrada, marzo 2026).
        //  La cadena hace: Reset Para -> R1 Goto Safety -> Wait R1 on safety
        //  -> Get NG buffer -> R1 Goto NG CDD -> CCD take picture
        //  -> R1 Goto NG buffer -> Refesh NG buffer, y repite hasta que el
        ...
        public void RestartProcessQuick()
        {
            ...
            MiddleLayer.LogF.AddLog(LogType.Production,
                "Reinicio rapido: se dispara la cadena npFlowChart39.", true);
